...
public class CycleButton<T> extends AbstractButton implements TooltipAccessor {
   ...
   private interface ValueListSupplier<T> {
      ...
      static <T> CycleButton.ValueListSupplier<T> create(BooleanSupplier var0, List<T> var1, List<T> var2) {
         ImmutableList var3 = ImmutableList.copyOf(var1);
         ImmutableList var4 = ImmutableList.copyOf(var2);
         return new CycleButton.ValueListSupplier<T>(var4, var3) {
            // $FF: synthetic field
            ...
            {
               this.val$altSelector = var1;
               this.val$altCopy = var2;
               this.val$defaultCopy = var3;
            }
