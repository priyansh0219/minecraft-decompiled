      ...
      RUN_ONE {
         public <E extends LivingEntity> void apply(Stream<Behavior<? super E>> var1, ServerLevel var2, E var3, long var4) {
            var1.filter((var0) -> {
               ...
               return var4.tryStart(var0, var1, var2);
            }).findFirst();
         }

         // $FF: synthetic method
         private static boolean lambda$apply$1(ServerLevel var0, LivingEntity var1, long var2, Behavior var4) {
            return var4.tryStart(var0, var1, var2);
         }

         // $FF: synthetic method
         private static boolean lambda$apply$0(Behavior var0) {
            return var0.getStatus() == Behavior.Status.STOPPED;
         }
      },
      TRY_ALL {
         public <E extends LivingEntity> void apply(Stream<Behavior<? super E>> var1, ServerLevel var2, E var3, long var4) {
            var1.filter((var0) -> {
               ...
               var4.tryStart(var0, var1, var2);
            });
         }

         // $FF: synthetic method
         private static void lambda$apply$1(ServerLevel var0, LivingEntity var1, long var2, Behavior var4) {
            var4.tryStart(var0, var1, var2);
         }
