...
public class GenerationStep {
   ...
   public static enum Decoration {
      ...
      private static GenerationStep.Decoration[] $values() {
         return new GenerationStep.Decoration[]{RAW_GENERATION, LAKES, LOCAL_MODIFICATIONS, UNDERGROUND_STRUCTURES, SURFACE_STRUCTURES, STRONGHOLDS, UNDERGROUND_ORES, UNDERGROUND_DECORATION, VEGETAL_DECORATION, TOP_LAYER_MODIFICATION};
      }
   }
}
