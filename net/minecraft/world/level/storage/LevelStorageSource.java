...
public class LevelStorageSource {
   ...
   public class LevelStorageAccess implements AutoCloseable {
      ...
      public void deleteLevel() throws IOException {
         this.checkLock();
         Path var1 = this.levelPath.resolve("session.lock");
         int var2 = 1;
         ...
         while(var2 <= 5) {
            ...
            try {
               Files.walkFileTree(this.levelPath, new SimpleFileVisitor<Path>(var1) {
                  // $FF: synthetic field
                  ...
                  public FileVisitResult visitFile(Path var1, BasicFileAttributes var2) throws IOException {
                     if (!var1.equals(this.val$lockPath)) {
                        LevelStorageSource.LOGGER.debug("Deleting {}", var1);
                        Files.delete(var1);
                     }
                  ...
                  public FileVisitResult postVisitDirectory(Path var1, IOException var2) throws IOException {
                     if (var2 != null) {
                        ...
                        if (var1.equals(this.this$1.levelPath)) {
                  ...
                  public FileVisitResult postVisitDirectory(Object var1, IOException var2) throws IOException {
                     return this.postVisitDirectory((Path)var1, var2);
                  }
      ...
      public long makeWorldBackup() throws IOException {
         ...
         ZipOutputStream var4 = new ZipOutputStream(new BufferedOutputStream(Files.newOutputStream(var3)));

         try {
            Path var5 = Paths.get(this.levelId);
            Files.walkFileTree(this.levelPath, new SimpleFileVisitor<Path>(var5, var4) {
               // $FF: synthetic field
               ...
               public FileVisitResult visitFile(Path var1, BasicFileAttributes var2) throws IOException {
                  if (var1.endsWith("session.lock")) {
                     ...
                     String var3 = this.val$rootPath.resolve(this.this$1.levelPath.relativize(var1)).toString().replace('\\', '/');
                     ZipEntry var4 = new ZipEntry(var3);
                     this.val$stream.putNextEntry(var4);
                     com.google.common.io.Files.asByteSource(var1.toFile()).copyTo(this.val$stream);
