...
public class Layers implements LayerBiomes {
   ...
   static enum Category {
      ...
      // $FF: synthetic method
      private static Layers.Category[] $values() {
         return new Layers.Category[]{NONE, TAIGA, EXTREME_HILLS, JUNGLE, MESA, BADLANDS_PLATEAU, PLAINS, SAVANNA, ICY, BEACH, FOREST, OCEAN, DESERT, RIVER, SWAMP, MUSHROOM};
      }
   }
}
