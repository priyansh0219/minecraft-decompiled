...
public class BiomeGenerationSettings {
   ...
   public static final MapCodec<BiomeGenerationSettings> CODEC = RecordCodecBuilder.mapCodec((var0) -> {
      RecordCodecBuilder var10001 = ConfiguredSurfaceBuilder.CODEC.fieldOf("surface_builder").flatXmap(ExtraCodecs.nonNullSupplierCheck(), ExtraCodecs.nonNullSupplierCheck()).forGetter((var0x) -> {
      ...
      RecordCodecBuilder var1 = Codec.simpleMap(var10002, var10003.promotePartial(Util.prefix("Carver: ", var10005::error)).flatXmap(ExtraCodecs.nonNullSupplierListCheck(), ExtraCodecs.nonNullSupplierListCheck()), StringRepresentable.keys(GenerationStep.Carving.values())).fieldOf("carvers").forGetter((var0x) -> {
         return var0x.carvers;
      });
      var10003 = ConfiguredFeature.LIST_CODEC;
      var10005 = LOGGER;
      Objects.requireNonNull(var10005);
      RecordCodecBuilder var2 = var10003.promotePartial(Util.prefix("Feature: ", var10005::error)).flatXmap(ExtraCodecs.nonNullSupplierListCheck(), ExtraCodecs.nonNullSupplierListCheck()).listOf().fieldOf("features").forGetter((var0x) -> {
         return var0x.features;
      });
      Codec var10004 = ConfiguredStructureFeature.LIST_CODEC;
      Logger var10006 = LOGGER;
      Objects.requireNonNull(var10006);
      return var0.group(var10001, var1, var2, var10004.promotePartial(Util.prefix("Structure start: ", var10006::error)).fieldOf("starts").flatXmap(ExtraCodecs.nonNullSupplierListCheck(), ExtraCodecs.nonNullSupplierListCheck()).forGetter((var0x) -> {
