...
public class DataFixers {
   ...
   private static void addFixers(DataFixerBuilder var0) {
      ...
      Schema var144 = var0.addSchema(2717, SAME_NAMESPACED);
      var0.addFixer(ItemRenameFix.create(var144, "Rename azalea_leaves_flowers", createRenamer(ImmutableMap.of("minecraft:azalea_leaves_flowers", "minecraft:flowering_azalea_leaves"))));
      var0.addFixer(BlockRenameFix.create(var144, "Rename azalea_leaves_flowers items", createRenamer(ImmutableMap.of("minecraft:azalea_leaves_flowers", "minecraft:flowering_azalea_leaves"))));
   }
