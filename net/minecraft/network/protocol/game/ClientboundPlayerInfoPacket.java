   ...
   public static enum Action {
      ADD_PLAYER {
         protected ClientboundPlayerInfoPacket.PlayerUpdate read(FriendlyByteBuf var1) {
            ...
            var1.readWithCount((var1) -> {
               String var2 = var1.readUtf();
               String var3 = var1.readUtf();
               if (var1.readBoolean()) {
                  String var4 = var1.readUtf();
                  var0.put(var2, new Property(var2, var3, var4));
               } else {
                  var0.put(var2, new Property(var2, var3));
               }
         ...
         protected void write(FriendlyByteBuf var1, ClientboundPlayerInfoPacket.PlayerUpdate var2) {
            ...
            var1.writeCollection(var2.getProfile().getProperties().values(), (var0, var1) -> {
         ...
         // $FF: synthetic method
         private static void lambda$write$1(FriendlyByteBuf var0, Property var1) {
            var0.writeUtf(var1.getName());
            var0.writeUtf(var1.getValue());
            if (var1.hasSignature()) {
               var0.writeBoolean(true);
         ...
         // $FF: synthetic method
         private static void lambda$read$0(PropertyMap var0, FriendlyByteBuf var1) {
            String var2 = var1.readUtf();
            String var3 = var1.readUtf();
            if (var1.readBoolean()) {
               String var4 = var1.readUtf();
